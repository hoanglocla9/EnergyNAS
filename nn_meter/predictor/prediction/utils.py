...
#     """
#     if "conv" in optype and "dwconv" in optype and len(optype.split("-")) == 4:
#         return "conv-relu-dwconv-relu"
#     if optype in ["dwconv-hswish", "dwconv-add", "dwconv-relu"] :
#         return "dwconv-relu"
#     if 'fc-hswish' == optype:
#         return "fc-relu"
#     if 'dwconv' == optype:
