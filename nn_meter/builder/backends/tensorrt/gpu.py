...
import re
from .tensorrt_profiler import TRTProfiler
from .tensorrt_backend import TRTBackend
from ..interface import BaseParser
from nn_meter.builder.backend_meta.utils import Latency, ProfiledResults


class TRTGPULatencyParser(BaseParser):
...
class TRTGPUProfiler(TRTProfiler):
    device = "JetsonNano"


class TRTGPUBackend(TRTBackend):
    parser_class = TRTGPULatencyParser
    profiler_class = TRTGPUProfiler
