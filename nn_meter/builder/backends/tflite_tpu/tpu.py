...
class TFLiteTPULatencyParser(BaseParser):
    def __init__(self):
        self.nodes = []
...
class TFLiteTPUProfiler(TFLiteProfiler):
    use_gpu = False


class TFLiteTPUBackend(TFLiteBackend):
    parser_class = TFLiteTPULatencyParser
    profiler_class = TFLiteTPUProfiler
