...
__BUILTIN_KERNELS__ = {
    ...
    #fc
    # "fc-relu": ["FcRelu", "FCSampler"],
    
    "fc-relu": ["FCRelu", "FCSampler"], # FCHswishFC # -fc

    # others
    "maxpool": ["MaxPoolBlock", "PoolingSampler"],
    "maxpool-bn": ["MaxPoolBNBlock", "PoolingSampler"],
    "avgpool": ["AvgPoolBlock", "PoolingSampler"],
    "avgpool-bn": ["AvgPoolBNBlock", "PoolingSampler"],
