...
class _model__layers(nn.Module):
    def __init__(self):
        super().__init__()
        self.mutable_all_0 = nni.retiarii.nn.pytorch.Conv1d(kernel_size=7, in_channels=1, out_channels=512, padding=3)
        self.mutable_all_conv_activation_0 = nni.retiarii.nn.pytorch.Hardtanh()
        self.mutable_all_1 = nni.retiarii.nn.pytorch.Conv1d(kernel_size=7, in_channels=512, out_channels=1, padding=3)
        ...
        self.mutable_all_fc_7 = nni.retiarii.nn.pytorch.Linear(in_features=512, out_features=1)
