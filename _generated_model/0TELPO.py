...
class _model__resnetblocks__blocks__0__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_0_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_isbn_0_1': 'resnetblocks.blocks.0.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_0_1 = self.layerchoice_resnetblock_isbn_0_1(_inputs[0])
        return layerchoice_resnetblock_isbn_0_1
...
class _model__resnetblocks__blocks__0(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=64, out_features=508)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.6)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=508, out_features=64)
...
class _model__resnetblocks__blocks__1__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_1_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=64)
...
class _model__resnetblocks__blocks__1(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=64, out_features=72)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.8)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=72, out_features=64)
...
class _model__resnetblocks__blocks__2__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_2_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_isbn_2_1': 'resnetblocks.blocks.2.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_2_1 = self.layerchoice_resnetblock_isbn_2_1(_inputs[0])
        return layerchoice_resnetblock_isbn_2_1
...
class _model__resnetblocks__blocks__2(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=64, out_features=88)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.4)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=88, out_features=64)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.4)
...
class _model__resnetblocks__blocks__3__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_3_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=64)
...
class _model__resnetblocks__blocks__3(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=64, out_features=260)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.2)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=260, out_features=64)
...
class _model__resnetblocks__blocks__4(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=64, out_features=484)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.1)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=484, out_features=64)
...
class _model__resnetblocks__blocks__5__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_5_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=64)
...
class _model__resnetblocks__blocks__5(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=64, out_features=212)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.1)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=212, out_features=64)
...
class _model__resnetblocks__blocks__6__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_6_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=64)
...
class _model__resnetblocks__blocks__6(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=64, out_features=428)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.9)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=428, out_features=64)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.4)
...
class _model__resnetblocks__blocks__7__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_7_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=64)
        self._mapping_ = {'layerchoice_resnetblock_isbn_7_0': 'resnetblocks.blocks.7.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_7_0 = self.layerchoice_resnetblock_isbn_7_0(_inputs[0])
        return layerchoice_resnetblock_isbn_7_0
...
class _model__resnetblocks__blocks__7(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=64, out_features=244)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.4)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=244, out_features=64)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.1)
...
class _model__resnetblocks__blocks__8__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_8_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=64)
        self._mapping_ = {'layerchoice_resnetblock_isbn_8_0': 'resnetblocks.blocks.8.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_8_0 = self.layerchoice_resnetblock_isbn_8_0(_inputs[0])
        return layerchoice_resnetblock_isbn_8_0
...
class _model__resnetblocks__blocks__8(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=64, out_features=348)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.9)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=348, out_features=64)
...
class _model__resnetblocks__blocks__9__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_9_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=64)
...
class _model__resnetblocks__blocks__9(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=64, out_features=496)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.4)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=496, out_features=64)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.2)
