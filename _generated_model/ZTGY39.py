...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_5 = nni.retiarii.nn.pytorch.Linear(in_features=512, out_features=1)
        self._mapping_ = {'mutable_all_0': 'layers.0', 'mutable_all_pooling': None, 'mutable_all_flatten': None, 'mutable_all_fc_0': None, 'mutable_all_fc_activation_0': None, 'mutable_all_fc_1': None, 'mutable_all_fc_activation_1': None, 'mutable_all_fc_2': None, 'mutable_all_fc_activation_2': None, 'mutable_all_fc_3': None, 'mutable_all_fc_activation_3': None, 'mutable_all_fc_4': None, 'mutable_all_fc_activation_4': None, 'mutable_all_fc_5': None}

    def forward(self, input__1):
        mutable_all_0 = self.mutable_all_0(input__1)
        mutable_all_pooling = self.mutable_all_pooling(mutable_all_0)
