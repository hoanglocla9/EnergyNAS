...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_13 = nni.retiarii.nn.pytorch.Linear(in_features=32, out_features=32)
        self.mutable_all_fc_activation_13 = nni.retiarii.nn.pytorch.PReLU()
        self.mutable_all_fc_14 = nni.retiarii.nn.pytorch.Linear(in_features=32, out_features=32)
        self.mutable_all_fc_activation_14 = nni.retiarii.nn.pytorch.PReLU()
        self.mutable_all_fc_15 = nni.retiarii.nn.pytorch.Linear(in_features=32, out_features=32)
        self.mutable_all_fc_activation_15 = nni.retiarii.nn.pytorch.PReLU()
        self.mutable_all_fc_16 = nni.retiarii.nn.pytorch.Linear(in_features=32, out_features=1)
