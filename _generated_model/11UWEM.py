...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_0 = nni.retiarii.nn.pytorch.Linear(in_features=33, out_features=2352)
        self.mutable_all_fc_1 = nni.retiarii.nn.pytorch.Linear(in_features=2352, out_features=2352)
        self.mutable_all_fc_2 = nni.retiarii.nn.pytorch.Linear(in_features=2352, out_features=2352)
        self.mutable_all_fc_3 = nni.retiarii.nn.pytorch.Linear(in_features=2352, out_features=1)
        self._mapping_ = {'mutable_all_0': 'layers.0', 'mutable_all_fc_0': None, 'mutable_all_fc_1': None, 'mutable_all_fc_2': None, 'mutable_all_fc_3': None}
