...
class _model__resnetblocks__blocks__0__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_0_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_0_1': 'resnetblocks.blocks.0.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_0_1 = self.layerchoice_resnetblock_0_1(_inputs[0])
        return layerchoice_resnetblock_0_1
...
class _model__resnetblocks__blocks__0(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=204, out_features=32)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.8)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=32, out_features=204)
...
class _model__resnetblocks__blocks__1__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_1_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=204)
        self._mapping_ = {'layerchoice_resnetblock_1_0': 'resnetblocks.blocks.1.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_1_0 = self.layerchoice_resnetblock_1_0(_inputs[0])
        return layerchoice_resnetblock_1_0
...
class _model__resnetblocks__blocks__2__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_2_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=204)
        self._mapping_ = {'layerchoice_resnetblock_2_0': 'resnetblocks.blocks.2.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_2_0 = self.layerchoice_resnetblock_2_0(_inputs[0])
        return layerchoice_resnetblock_2_0
...
class _model__resnetblocks__blocks__3__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_3_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=204)
...
class _model__resnetblocks__blocks__4__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_4_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_4_1': 'resnetblocks.blocks.4.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_4_1 = self.layerchoice_resnetblock_4_1(_inputs[0])
        return layerchoice_resnetblock_4_1
...
class _model__resnetblocks__blocks__5__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_5_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=204)
        self._mapping_ = {'layerchoice_resnetblock_5_0': 'resnetblocks.blocks.5.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_5_0 = self.layerchoice_resnetblock_5_0(_inputs[0])
        return layerchoice_resnetblock_5_0
...
class _model__resnetblocks__blocks__6__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_6_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=204)
        self._mapping_ = {'layerchoice_resnetblock_6_0': 'resnetblocks.blocks.6.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_6_0 = self.layerchoice_resnetblock_6_0(_inputs[0])
        return layerchoice_resnetblock_6_0
...
class _model__resnetblocks__blocks__7__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_7_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_7_1': 'resnetblocks.blocks.7.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_7_1 = self.layerchoice_resnetblock_7_1(_inputs[0])
        return layerchoice_resnetblock_7_1
...
class _model__resnetblocks__blocks__8__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_8_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_8_1': 'resnetblocks.blocks.8.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_8_1 = self.layerchoice_resnetblock_8_1(_inputs[0])
        return layerchoice_resnetblock_8_1
...
class _model__resnetblocks(nn.Module):
    def __init__(self):
        ...
        self._blocks__6 = _model__resnetblocks__blocks__6()
        self._blocks__7 = _model__resnetblocks__blocks__7()
        self._blocks__8 = _model__resnetblocks__blocks__8()
        self._mapping_ = {'_blocks__0': 'resnetblocks.blocks.0', '_blocks__1': 'resnetblocks.blocks.1', '_blocks__2': 'resnetblocks.blocks.2', '_blocks__3': 'resnetblocks.blocks.3', '_blocks__4': 'resnetblocks.blocks.4', '_blocks__5': 'resnetblocks.blocks.5', '_blocks__6': 'resnetblocks.blocks.6', '_blocks__7': 'resnetblocks.blocks.7', '_blocks__8': 'resnetblocks.blocks.8'}
    ...
    def forward(self, x__1):
        ...
        _blocks__6 = self._blocks__6(_blocks__5)
        _blocks__7 = self._blocks__7(_blocks__6)
        _blocks__8 = self._blocks__8(_blocks__7)
        return _blocks__8
...
class _model__head__batchnorm(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnet_head_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=204)
        self._mapping_ = {'layerchoice_resnet_head_0': 'head.batchnorm.0'}

    def forward(self, *_inputs):
        layerchoice_resnet_head_0 = self.layerchoice_resnet_head_0(_inputs[0])
        return layerchoice_resnet_head_0
...
class _model__head(nn.Module):
    def __init__(self):
        ...
        self._linear = torch.nn.modules.linear.Linear(in_features=204, out_features=1)
...
class _model(nn.Module):
    def __init__(self):
        super().__init__()
        self._first_layer = torch.nn.modules.linear.Linear(in_features=33, out_features=204)
