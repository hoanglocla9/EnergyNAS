...
class _model__resnetblocks__blocks__0__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_0_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=104)
...
class _model__resnetblocks__blocks__0(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=104, out_features=140)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.8)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=140, out_features=104)
...
class _model__resnetblocks__blocks__1__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_1_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=104)
...
class _model__resnetblocks__blocks__1(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=104, out_features=460)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.6)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=460, out_features=104)
...
class _model__resnetblocks__blocks__2(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=104, out_features=484)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.9)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=484, out_features=104)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.9)
...
class _model__resnetblocks__blocks__3__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_3_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=104)
...
class _model__resnetblocks__blocks__3(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=104, out_features=500)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.6)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=500, out_features=104)
...
class _model__resnetblocks__blocks__4__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_4_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=104)
        self._mapping_ = {'layerchoice_resnetblock_isbn_4_0': 'resnetblocks.blocks.4.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_4_0 = self.layerchoice_resnetblock_isbn_4_0(_inputs[0])
        return layerchoice_resnetblock_isbn_4_0
...
class _model__resnetblocks__blocks__4(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=104, out_features=512)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.9)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=512, out_features=104)
...
class _model__resnetblocks__blocks__5__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_5_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=104)
...
class _model__resnetblocks__blocks__5(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=104, out_features=368)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.2)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=368, out_features=104)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.6)
...
class _model__resnetblocks__blocks__6__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_6_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_isbn_6_1': 'resnetblocks.blocks.6.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_6_1 = self.layerchoice_resnetblock_isbn_6_1(_inputs[0])
        return layerchoice_resnetblock_isbn_6_1
...
class _model__resnetblocks__blocks__6(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=104, out_features=84)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.2)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=84, out_features=104)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.9)
...
class _model__resnetblocks__blocks__7(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=104, out_features=488)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.1)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=488, out_features=104)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.6)
...
class _model__resnetblocks__blocks__8__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_8_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=104)
...
class _model__resnetblocks__blocks__8(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=104, out_features=236)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.4)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=236, out_features=104)
...
class _model__resnetblocks__blocks__9__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_9_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_isbn_9_1': 'resnetblocks.blocks.9.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_9_1 = self.layerchoice_resnetblock_isbn_9_1(_inputs[0])
        return layerchoice_resnetblock_isbn_9_1
...
class _model__head(nn.Module):
    def __init__(self):
        ...
        self._linear = torch.nn.modules.linear.Linear(in_features=104, out_features=1)
...
class _model(nn.Module):
    def __init__(self):
        super().__init__()
        self._first_layer = torch.nn.modules.linear.Linear(in_features=33, out_features=104)
