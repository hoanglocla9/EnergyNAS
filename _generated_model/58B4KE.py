...
class _model__resnetblocks__blocks__0(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=252, out_features=32)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.1)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=32, out_features=252)
...
class _model__resnetblocks__blocks__1__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_1_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=252)
...
class _model__resnetblocks__blocks__2__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_2_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=252)
...
class _model__resnetblocks__blocks__3__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_3_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_3_1': 'resnetblocks.blocks.3.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_3_1 = self.layerchoice_resnetblock_3_1(_inputs[0])
        return layerchoice_resnetblock_3_1
...
class _model__resnetblocks__blocks__9__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_9_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=252)
        self._mapping_ = {'layerchoice_resnetblock_9_0': 'resnetblocks.blocks.9.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_9_0 = self.layerchoice_resnetblock_9_0(_inputs[0])
        return layerchoice_resnetblock_9_0
...
class _model__head__batchnorm(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnet_head_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=252)
...
class _model__head(nn.Module):
    def __init__(self):
        ...
        self._linear = torch.nn.modules.linear.Linear(in_features=252, out_features=1)
...
class _model(nn.Module):
    def __init__(self):
        super().__init__()
        self._first_layer = torch.nn.modules.linear.Linear(in_features=33, out_features=252)
