...
class _model__resnetblocks__blocks__3__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_3_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=80)
...
class _model__resnetblocks__blocks__4__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_4_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=80)
