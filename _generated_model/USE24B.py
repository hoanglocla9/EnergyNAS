...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_4 = nni.retiarii.nn.pytorch.Linear(in_features=1400, out_features=1400)
        self.mutable_all_fc_activation_4 = nni.retiarii.nn.pytorch.Hardsigmoid()
        self.mutable_all_fc_5 = nni.retiarii.nn.pytorch.Linear(in_features=1400, out_features=1)
