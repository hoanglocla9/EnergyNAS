...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_activation_7 = nni.retiarii.nn.pytorch.Softplus()
        self.mutable_all_fc_8 = nni.retiarii.nn.pytorch.Linear(in_features=16, out_features=16)
        self.mutable_all_fc_activation_8 = nni.retiarii.nn.pytorch.Softplus()
        self.mutable_all_fc_9 = nni.retiarii.nn.pytorch.Linear(in_features=16, out_features=16)
        self.mutable_all_fc_activation_9 = nni.retiarii.nn.pytorch.Softplus()
        self.mutable_all_fc_10 = nni.retiarii.nn.pytorch.Linear(in_features=16, out_features=1)
