...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_0 = nni.retiarii.nn.pytorch.Linear(in_features=33, out_features=3844)
        ...
        self.mutable_all_fc_1 = nni.retiarii.nn.pytorch.Linear(in_features=3844, out_features=1)
        self._mapping_ = {'mutable_all_0': 'layers.0', 'mutable_all_fc_0': None, 'mutable_all_fc_activation_0': None, 'mutable_all_fc_dropout_0': None, 'mutable_all_fc_1': None}
