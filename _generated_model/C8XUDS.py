...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_activation_10 = nni.retiarii.nn.pytorch.Softplus()
        self.mutable_all_fc_11 = nni.retiarii.nn.pytorch.Linear(in_features=32, out_features=32)
        self.mutable_all_fc_activation_11 = nni.retiarii.nn.pytorch.Softplus()
        self.mutable_all_fc_12 = nni.retiarii.nn.pytorch.Linear(in_features=32, out_features=32)
        self.mutable_all_fc_activation_12 = nni.retiarii.nn.pytorch.Softplus()
        self.mutable_all_fc_13 = nni.retiarii.nn.pytorch.Linear(in_features=32, out_features=32)
        self.mutable_all_fc_activation_13 = nni.retiarii.nn.pytorch.Softplus()
        self.mutable_all_fc_14 = nni.retiarii.nn.pytorch.Linear(in_features=32, out_features=32)
        self.mutable_all_fc_activation_14 = nni.retiarii.nn.pytorch.Softplus()
        self.mutable_all_fc_15 = nni.retiarii.nn.pytorch.Linear(in_features=32, out_features=1)
