...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_7 = nni.retiarii.nn.pytorch.Linear(in_features=4, out_features=4)
        self.mutable_all_fc_activation_7 = nni.retiarii.nn.pytorch.Hardtanh()
        self.mutable_all_fc_8 = nni.retiarii.nn.pytorch.Linear(in_features=4, out_features=1)
