...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_0 = nni.retiarii.nn.pytorch.Linear(in_features=33, out_features=3752)
        self.mutable_all_fc_activation_0 = nni.retiarii.nn.pytorch.Hardtanh()
        self.mutable_all_fc_1 = nni.retiarii.nn.pytorch.Linear(in_features=3752, out_features=3752)
        self.mutable_all_fc_activation_1 = nni.retiarii.nn.pytorch.Hardtanh()
        self.mutable_all_fc_2 = nni.retiarii.nn.pytorch.Linear(in_features=3752, out_features=3752)
        self.mutable_all_fc_activation_2 = nni.retiarii.nn.pytorch.Hardtanh()
        self.mutable_all_fc_3 = nni.retiarii.nn.pytorch.Linear(in_features=3752, out_features=3752)
        self.mutable_all_fc_activation_3 = nni.retiarii.nn.pytorch.Hardtanh()
        self.mutable_all_fc_4 = nni.retiarii.nn.pytorch.Linear(in_features=3752, out_features=3752)
        self.mutable_all_fc_activation_4 = nni.retiarii.nn.pytorch.Hardtanh()
        self.mutable_all_fc_5 = nni.retiarii.nn.pytorch.Linear(in_features=3752, out_features=1)
