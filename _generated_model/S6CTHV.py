...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_0 = nni.retiarii.nn.pytorch.Linear(in_features=33, out_features=1436)
        ...
        self.mutable_all_fc_1 = nni.retiarii.nn.pytorch.Linear(in_features=1436, out_features=1436)
        ...
        self.mutable_all_fc_2 = nni.retiarii.nn.pytorch.Linear(in_features=1436, out_features=1436)
        ...
        self.mutable_all_fc_3 = nni.retiarii.nn.pytorch.Linear(in_features=1436, out_features=1436)
        ...
        self.mutable_all_fc_4 = nni.retiarii.nn.pytorch.Linear(in_features=1436, out_features=1)
