...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_0 = nni.retiarii.nn.pytorch.Linear(in_features=33, out_features=628)
        ...
        self.mutable_all_fc_1 = nni.retiarii.nn.pytorch.Linear(in_features=628, out_features=628)
        ...
        self.mutable_all_fc_2 = nni.retiarii.nn.pytorch.Linear(in_features=628, out_features=1)
