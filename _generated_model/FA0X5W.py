...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_0 = nni.retiarii.nn.pytorch.Linear(in_features=33, out_features=1648)
        self.mutable_all_fc_activation_0 = nni.retiarii.nn.pytorch.Tanh()
        self.mutable_all_fc_1 = nni.retiarii.nn.pytorch.Linear(in_features=1648, out_features=1648)
        self.mutable_all_fc_activation_1 = nni.retiarii.nn.pytorch.Tanh()
        self.mutable_all_fc_2 = nni.retiarii.nn.pytorch.Linear(in_features=1648, out_features=1648)
        self.mutable_all_fc_activation_2 = nni.retiarii.nn.pytorch.Tanh()
        self.mutable_all_fc_3 = nni.retiarii.nn.pytorch.Linear(in_features=1648, out_features=1648)
        self.mutable_all_fc_activation_3 = nni.retiarii.nn.pytorch.Tanh()
        self.mutable_all_fc_4 = nni.retiarii.nn.pytorch.Linear(in_features=1648, out_features=1648)
        self.mutable_all_fc_activation_4 = nni.retiarii.nn.pytorch.Tanh()
        self.mutable_all_fc_5 = nni.retiarii.nn.pytorch.Linear(in_features=1648, out_features=1648)
        self.mutable_all_fc_activation_5 = nni.retiarii.nn.pytorch.Tanh()
        self.mutable_all_fc_6 = nni.retiarii.nn.pytorch.Linear(in_features=1648, out_features=1648)
        self.mutable_all_fc_activation_6 = nni.retiarii.nn.pytorch.Tanh()
        self.mutable_all_fc_7 = nni.retiarii.nn.pytorch.Linear(in_features=1648, out_features=1648)
        self.mutable_all_fc_activation_7 = nni.retiarii.nn.pytorch.Tanh()
        self.mutable_all_fc_8 = nni.retiarii.nn.pytorch.Linear(in_features=1648, out_features=1)
