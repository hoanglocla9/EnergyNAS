...
class _model__layers(nn.Module):
    def __init__(self):
        ...
        self.mutable_all_fc_16 = nni.retiarii.nn.pytorch.Linear(in_features=32, out_features=32)
        self.mutable_all_fc_activation_16 = nni.retiarii.nn.pytorch.ReLU6()
        self.mutable_all_fc_17 = nni.retiarii.nn.pytorch.Linear(in_features=32, out_features=1)
