...
class _model__resnetblocks__blocks__0(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=4, out_features=32)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.9)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=32, out_features=4)
...
class _model__resnetblocks__blocks__2__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_2_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=4)
...
class _model__resnetblocks__blocks__3__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_3_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=4)
...
class _model__resnetblocks__blocks__5__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_5_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=4)
...
class _model__resnetblocks__blocks__6__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_6_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=4)
...
class _model__resnetblocks(nn.Module):
    def __init__(self):
        ...
        self._blocks__9 = _model__resnetblocks__blocks__9()
        self._mapping_ = {'_blocks__0': 'resnetblocks.blocks.0', '_blocks__1': 'resnetblocks.blocks.1', '_blocks__2': 'resnetblocks.blocks.2', '_blocks__3': 'resnetblocks.blocks.3', '_blocks__4': 'resnetblocks.blocks.4', '_blocks__5': 'resnetblocks.blocks.5', '_blocks__6': 'resnetblocks.blocks.6', '_blocks__7': 'resnetblocks.blocks.7', '_blocks__8': 'resnetblocks.blocks.8', '_blocks__9': 'resnetblocks.blocks.9'}
    ...
    def forward(self, x__1):
        ...
        _blocks__9 = self._blocks__9(_blocks__8)
        return _blocks__9
...
class _model(nn.Module):
    def __init__(self):
        super().__init__()
        self._first_layer = torch.nn.modules.linear.Linear(in_features=33, out_features=4)
