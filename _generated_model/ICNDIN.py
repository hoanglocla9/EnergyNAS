...
class _model__resnetblocks__blocks__2__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_2_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=132)
...
class _model__resnetblocks__blocks__5__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_5_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=132)
...
class _model__resnetblocks__blocks__8__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_8_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=132)
