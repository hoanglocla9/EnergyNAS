...
class _model__resnetblocks__blocks__0__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_0_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=160)
...
class _model__resnetblocks__blocks__0(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=160, out_features=32)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.2)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=32, out_features=160)
...
class _model__resnetblocks__blocks__2__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_2_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=160)
...
class _model__resnetblocks__blocks__3__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_3_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=160)
...
class _model__resnetblocks__blocks__5__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_5_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=160)
...
class _model__resnetblocks__blocks__6__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_6_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=160)
...
class _model__resnetblocks__blocks__8__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_8_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=160)
...
class _model__head__batchnorm(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnet_head_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=160)
...
class _model__head(nn.Module):
    def __init__(self):
        ...
        self._linear = torch.nn.modules.linear.Linear(in_features=160, out_features=1)
...
class _model(nn.Module):
    def __init__(self):
        super().__init__()
        self._first_layer = torch.nn.modules.linear.Linear(in_features=33, out_features=160)
