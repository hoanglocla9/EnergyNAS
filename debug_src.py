...
class _model__resnetblocks__blocks__0__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_0_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=4)
        self._mapping_ = {'layerchoice_resnetblock_isbn_0_0': 'resnetblocks.blocks.0.batchnorm_1.0'}

    def forward(self, *_inputs):
        print(_inputs[0].shape)
        layerchoice_resnetblock_isbn_0_0 = self.layerchoice_resnetblock_isbn_0_0(_inputs[0])
        return layerchoice_resnetblock_isbn_0_0
...
class _model__resnetblocks__blocks__0(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=4, out_features=264)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.6)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=264, out_features=4)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.8)
    ...
    def forward(self, x__1):
        ...
        _batchnorm_1 = self._batchnorm_1(x__1)
...
class _model__resnetblocks__blocks__1__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_1_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=4)
        self._mapping_ = {'layerchoice_resnetblock_isbn_1_0': 'resnetblocks.blocks.1.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_1_0 = self.layerchoice_resnetblock_isbn_1_0(_inputs[0])
        return layerchoice_resnetblock_isbn_1_0
...
class _model__resnetblocks__blocks__1(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=4, out_features=152)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.8)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=152, out_features=4)
...
class _model__resnetblocks__blocks__2__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_2_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=4)
        self._mapping_ = {'layerchoice_resnetblock_isbn_2_0': 'resnetblocks.blocks.2.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_2_0 = self.layerchoice_resnetblock_isbn_2_0(_inputs[0])
        return layerchoice_resnetblock_isbn_2_0
...
class _model__resnetblocks__blocks__2(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=4, out_features=428)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.9)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=428, out_features=4)
...
class _model__resnetblocks__blocks__3__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_3_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=4)
        self._mapping_ = {'layerchoice_resnetblock_isbn_3_0': 'resnetblocks.blocks.3.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_3_0 = self.layerchoice_resnetblock_isbn_3_0(_inputs[0])
        return layerchoice_resnetblock_isbn_3_0
...
class _model__resnetblocks__blocks__3(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=4, out_features=136)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.2)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=136, out_features=4)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.1)
...
class _model__resnetblocks__blocks__4__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_4_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_isbn_4_1': 'resnetblocks.blocks.4.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_4_1 = self.layerchoice_resnetblock_isbn_4_1(_inputs[0])
        return layerchoice_resnetblock_isbn_4_1
...
class _model__resnetblocks__blocks__4(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=4, out_features=472)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.4)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=472, out_features=4)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.8)
...
class _model__resnetblocks__blocks__5__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_5_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=4)
        self._mapping_ = {'layerchoice_resnetblock_isbn_5_0': 'resnetblocks.blocks.5.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_5_0 = self.layerchoice_resnetblock_isbn_5_0(_inputs[0])
        return layerchoice_resnetblock_isbn_5_0
...
class _model__resnetblocks__blocks__5(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=4, out_features=72)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.9)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=72, out_features=4)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.2)
...
class _model__resnetblocks__blocks__6__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_6_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=4)
        self._mapping_ = {'layerchoice_resnetblock_isbn_6_0': 'resnetblocks.blocks.6.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_6_0 = self.layerchoice_resnetblock_isbn_6_0(_inputs[0])
        return layerchoice_resnetblock_isbn_6_0
...
class _model__resnetblocks__blocks__6(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=4, out_features=24)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.4)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=24, out_features=4)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.4)
...
class _model__resnetblocks__blocks__7__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_7_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_isbn_7_1': 'resnetblocks.blocks.7.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_7_1 = self.layerchoice_resnetblock_isbn_7_1(_inputs[0])
        return layerchoice_resnetblock_isbn_7_1
...
class _model__resnetblocks__blocks__7(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=4, out_features=116)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.1)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=116, out_features=4)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.1)
...
class _model__resnetblocks__blocks__8__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_8_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnetblock_isbn_8_1': 'resnetblocks.blocks.8.batchnorm_1.1'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_8_1 = self.layerchoice_resnetblock_isbn_8_1(_inputs[0])
        return layerchoice_resnetblock_isbn_8_1
...
class _model__resnetblocks__blocks__8(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=4, out_features=460)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.1)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=460, out_features=4)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.1)
...
class _model__resnetblocks__blocks__9__batchnorm_1(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnetblock_isbn_9_0 = torch.nn.modules.batchnorm.BatchNorm1d(num_features=4)
        self._mapping_ = {'layerchoice_resnetblock_isbn_9_0': 'resnetblocks.blocks.9.batchnorm_1.0'}

    def forward(self, *_inputs):
        layerchoice_resnetblock_isbn_9_0 = self.layerchoice_resnetblock_isbn_9_0(_inputs[0])
        return layerchoice_resnetblock_isbn_9_0
...
class _model__resnetblocks__blocks__9(nn.Module):
    def __init__(self):
        ...
        self._linear_1 = torch.nn.modules.linear.Linear(in_features=4, out_features=332)
        self._relu_1 = torch.nn.modules.activation.ReLU()
        self._dropout_1 = torch.nn.modules.dropout.Dropout(p=0.9)
        self._linear_2 = torch.nn.modules.linear.Linear(in_features=332, out_features=4)
        self._dropout_2 = torch.nn.modules.dropout.Dropout(p=0.6)
...
class _model__resnetblocks(nn.Module):
    def __init__(self):
        ...
        self._mapping_ = {'_blocks__0': 'resnetblocks.blocks.0', '_blocks__1': 'resnetblocks.blocks.1', '_blocks__2': 'resnetblocks.blocks.2', '_blocks__3': 'resnetblocks.blocks.3', '_blocks__4': 'resnetblocks.blocks.4'}
...
class _model__head__batchnorm(nn.Module):
    def __init__(self):
        super().__init__()
        self.layerchoice_resnethead_isbn_1 = torch.nn.modules.linear.Identity()
        self._mapping_ = {'layerchoice_resnethead_isbn_1': 'head.batchnorm.1'}

    def forward(self, *_inputs):
        layerchoice_resnethead_isbn_1 = self.layerchoice_resnethead_isbn_1(_inputs[0])
        return layerchoice_resnethead_isbn_1
...
class _model__head(nn.Module):
    def __init__(self):
        ...
        self._linear = torch.nn.modules.linear.Linear(in_features=4, out_features=1)
...
class _model(nn.Module):
    def __init__(self):
        super().__init__()
        self._first_layer = torch.nn.modules.linear.Linear(in_features=33, out_features=184)
